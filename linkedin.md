...
- **Agentic LLM Router**: Initially, I built a mathematical vector-router using cosine similarity, but it struggled with nuanced context. I ripped it out and engineered a highly optimized Agentic Intent Classifier using `gpt-4o-mini`. Incoming messages are instantly evaluated and dynamically routed to the "Save", "Query", or "Both" downstream pipelines. It understands exactly *what* you mean, executing complex multi-step workflows for fractions of a penny.
...
🔗 GitHub : <https://github.com/GourangNagar/askKAI>
🔗 Live URL:  <https://kai-backend-103924552372.asia-south1.run.app>
